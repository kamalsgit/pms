...
const app = angular.module('pmsApp',['ngAnimate', 'ngDragDrop','angularUtils.directives.dirPagination','720kb.datepicker','templates','moment-picker']).directive('multipleAutocomplete', [
        '$filter',
        '$http',

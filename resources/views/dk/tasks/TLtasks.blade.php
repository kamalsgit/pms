...
@section('pageData')
<div class='col-lg-12' ng-controller='TLTaskController'>
							...
							<div class="modal-dialog">
							  ...
							  <div class="modal-content">
								...
								<form name="task" method="post" action="/attension/create" id="employee" ng-hide="showForm">
									...
									<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12"> No Threads </div>
...
@section('scripts')
<script type="text/javascript" src="{!! asset('app/controller/dk/TLTaskController.js') !!}"></script>
@endsection
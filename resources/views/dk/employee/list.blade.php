...
@section('pageData')
	<div class='col-lg-12' ng-controller='dkemployeeController'>
		<div class="container-fluid text-center">
			<div class="col-sm-10 sidenav">
				<h4 class="header">Employee
				<div class="dropdown">
				  <button class="dropbtn" ng-click="empadd()">Add Employees</button>
				</div>
				</h4>
				...
				<div class="col-sm-9 text-left content panel panel-default">
					<div class="employeelist" ng-hide="showList">
						...
						<table class="table table-striped table-hover" ng-init='itemsperpage=5'>
									...
									<tr>
										...
										<td>
											<div id="profile" class="col-md-12">
												...
												<div class="col-md-6">
													<img ng-click="empdel({{ $emp['emp_id']}})" src="{{ asset('image/delete.png') }}">
												</div>
											</div>
										</td>
									</tr>
							...
							<tfoot>
								<tr><td colspan=6> {{ $employees->links() }}</td></tr>
							</tfoot>
						</table> 
					</div>
					@include('dk.employee.create')
				</div>
			</div>
...
<script type="text/javascript" src="{!! asset('app/controller/dk/employeeController.js') !!}"></script>
@endsection

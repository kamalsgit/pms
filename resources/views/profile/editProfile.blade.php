...
<input type="hidden" value="<?php echo $user->gender; ?>" ng-value="{{$user->gender}}" ng-model="genders">
<style>
  .personal{
...
<h4 class="header">What's New</h4>
    ...
    <!--<form name="updateProfile" method="post" action="saveProfile">
        <div class="form-layout">
            ...
            <label for="business_skype">
                Business Skype:
                <p>{{$user->business_skype}}</p>
            </label>

            <label for="role">
                My role:
                <p> {{$user->business_email}} Need to write </p>
            </label>
            <label for="doj">
                Date Of Join:
                <p> {{$user->dateofjoin}} </p>
        ...
        <div class="form-layout">
            <label for="personal_email">
                Personal Email:
                <input type="email" name="personal_email" value="{{$user->personal_email}}">
            </label>
            <label for="personal_skype">
                Personal Skype:
                <input type="text" name="personal_skype" value="{{$user->personal_skype}}">
            </label>
            <label for="birthday">
                Birthday :
                <input type="text" name="birthday" value="">
                <datepicker date-format="d MMMM, y">
                    <input required name="birthday" ng-model="test" type="text" readonly=""  value="" name="birthday" placeholder="Select Birth Date"/>
                </datepicker>
            </label>
            <label for="current_address">
                Current Address :
                <textarea name="current_address" >{{$user->current_address}}</textarea>
            </label>
            <label for="perment_address">
                personal Address :
                <textarea name="perment_address">{{$user->perment_address}}</textarea>
            </label>
            <label for="maridstatus">
                <label for="single"> <input type="radio" name="maritalstatus"  id="single" value="0" {{($user->is_married==0)?"checked=checked":""}}>Single</label>
                <label for="married"> <input type="radio" name="maritalstatus" id="married" value="1" {{($user->is_married==1)?"checked=checked":""}}>Married</label>
            </label>
            <div ng-show="married">
                <label for="partner_name">
                    Partner Name:
                    <input type="text" id="partner_name" name="partner_name" value="{{$user->partner_name}}">
                </label>
                <label for="partner_phone">
                    Partner Phone :
                    <input type="text" id="partner_phone" name="partner_phone" value="{{$user->partner_phone}}">
                </label>
                <label for="aniversary">
                    Aniversary :
                    <input type="text" name="aniversary" value="{{$user->anniversary}}">
                </label>
            </div>
            <div class="form-layout">

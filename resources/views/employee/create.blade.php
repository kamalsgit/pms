	...
	<div class="row">
		...
		<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-6">
			...
			<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<select class="form-control" name='role_id' ng-model="employee.role_id" ng-readonly="truefalse" ng-options="role.role_id as role.role_title for role in roles_temp">
				</select>
			</div>
			...
			<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<datepicker date-format="d MMMM y">
				<input class="form-control" required name="dateofjoin" ng-model="employee.dateofjoin" readonly="" type="text" placeholder="select date of joining"/>
